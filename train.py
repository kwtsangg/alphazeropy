...
if __name__ == "__main__":
  ...
  parser.add_argument("--n-in-row",                             action="store",            type=int,   help="It is needed if game is gomoku or connectfour")
  # AI brain params
  parser.add_argument("--save-path",                            action="store",            type=str,   help="")
  parser.add_argument("--load-path",                            action="store",            type=str,   help="")
  ...
  # training params 
  parser.add_argument("--optimizer",         default="adam",    action="store",            type=str,   help="method of gradient descent")
